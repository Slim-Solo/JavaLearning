...
/*Reduce() — это функция высшего порядка в JavaScript, которая принимает массив и сводит его к одному значению,
применяя заданную функцию к каждому элементу массива последовательно*/